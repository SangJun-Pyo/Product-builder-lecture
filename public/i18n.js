...
const i18n = {
  ...
  messages: {
    en: {
      ...
      stat_games_analyzed: "Games Analyzed",
      stat_groups: "Groups",
      ...
      recommendations_desc: "Games suggested based on your playstyle archetype. Higher match = better fit for you.",
      disclaimer_text: "These are personalized recommendations based on your playstyle archetype analysis, not a record of your gameplay history.",
      no_recommendations: "Unable to generate recommendations. Try analyzing more data.",
    ...
    ko: {
      ...
      recommendations_desc: "플레이스타일 아키타입을 기반으로 추천된 게임입니다. 매칭 점수가 높을수록 더 적합합니다.",
      disclaimer_text: "이 게임들은 플레이스타일 분석을 기반으로 한 개인화된 추천이며, 실제 게임 플레이 기록이 아닙니다.",
      no_recommendations: "추천을 생성할 수 없습니다. 더 많은 데이터로 다시 시도해주세요.",
      ...
      // Personalized Insights
      insight_explorer: "새로운 경험을 발견하는 호기심이 있으시네요. 다양성과 모험을 즐기는 플레이스타일입니다. 탐험, 퀘스트, 새로운 세계를 발견할 수 있는 게임을 추천드립니다.",
      insight_grinder: "성장에 대한 열정이 대단하시네요! 장기 목표와 가시적인 성취에서 동기를 얻습니다. 깊은 성장 시스템과 프레스티지 메커닉이 있는 게임을 추천드립니다.",
      insight_socializer: "게임 경험의 핵심에 연결이 있습니다. 커뮤니티와 우정을 소중히 여기시네요. 활발한 소셜 기능과 협동 게임플레이가 있는 게임을 추천드립니다.",
      insight_competitor: "도전과 경쟁의 스릴에 동기부여를 받습니다. 향상과 승리가 원동력이네요. PvP, 랭크 모드, 스킬 기반 매칭이 있는 게임을 추천드립니다.",
      insight_builder: "게임플레이에 창의력이 흐릅니다. 디자인하고, 건설하고, 자신을 표현하는 것을 좋아하시네요. 샌드박스 게임과 창작 도구를 추천드립니다.",
      insight_trader: "가치와 경제에 대한 날카로운 눈이 있습니다. 전략적 사고가 강점이네요. 거래 시스템, 시장 경제, 비즈니스 시뮬레이션 게임을 추천드립니다.",
      insight_roleplayer: "상상력이 모든 게임을 스토리로 바꿉니다. 캐릭터와 내러티브가 경험을 이끕니다. 풍부한 스토리와 롤플레이 커뮤니티가 있는 게임을 추천드립니다.",
      insight_casual: "부담 없이 순수한 즐거움을 위해 플레이합니다. 재미와 휴식이 우선이네요. 짧은 세션과 간단한 메커닉의 접근하기 쉬운 게임을 추천드립니다."
    }
  },
